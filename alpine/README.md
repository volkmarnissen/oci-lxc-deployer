...
This directory contains the Alpine Linux package build system for multiple packages (e.g., `modbus2mqtt`, `oci-lxc-deployer`). It supports templated generation via INI files and generic build scripts.
...
│   └── oci-lxc-deployer/               # Example generated/maintained package
